...
class Config implements ConfigInterface
{
    ...
    public static function page(): PageForm
    {
        $fields = [
            ...
            // 'vod_hls_name'        => FormItem::make()->title('云点播hls加密任务流名称')->help('前往 <a href="https://console.cloud.tencent.com/vod/video-process/taskflow" target="_blank" class="el-link el-link--primary">任务流设置</a> 添加转自适应码流/Adpative-HLS-Encrypt(12)'),
            ...
            'bucket'              => FormItem::make()->title('Cos储存桶名称')->help('若不需要上传非音视频、图片资源时，可不填写'),
            'cos_region'          => FormItem::make()->title('Cos存储桶地域')->help('若不需要上传非音视频、图片资源时，可不填写'),
        ];
